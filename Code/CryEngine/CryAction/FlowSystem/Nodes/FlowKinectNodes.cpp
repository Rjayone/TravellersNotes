...
class CKinectGestureSystem
{
	...
	private:
		...
		typedef std::unordered_map<string, CKinectPose, stl::hash_strcmp<string>, stl::hash_strcmp<string>> TPoseMap;

		typedef std::unordered_map<string, CKinectGesture, stl::hash_strcmp<string>, stl::hash_strcmp<string>> TGestureMap;
