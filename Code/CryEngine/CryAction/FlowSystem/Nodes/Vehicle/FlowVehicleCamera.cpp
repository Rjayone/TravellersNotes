...
public:
	...
	void GetConfiguration(SFlowNodeConfig &nodeConfig)
	{
		...
		static const SInputPortConfig pInConfig[] =
		{
			...
			InputPortConfig<string>("vehicleSeatViews_SeatView", _HELP("Seat View to be changed"), _HELP("Seat View"), _UICONFIG("ref_entity=entityId")),
			{0}
		};

		static const SOutputPortConfig pOutConfig[] =
		{
			OutputPortConfig<bool>("Success", _HELP("Activated when the view is changes change successfully or fails")),
			{0}
		};
...
public:
	...
	virtual void GetConfiguration(SFlowNodeConfig &config)
	{
		static const SInputPortConfig pInConfig[] =
		{
			...
			InputPortConfig<string>("vehicleSeatViews_SeatView", _HELP("Seat View to be enabled/disabled"), _HELP("Seat View"), _UICONFIG("ref_entity=entityId")),
			{0}
		};
