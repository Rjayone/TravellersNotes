...
private:
	...
	void ExecuteOnProxy(IEntity* const pEntity, TAudioControlID const nTriggerID, EPlayMode const ePlayMode)
	{
		...
		if (pIEntityAudioProxy != nullptr)
		{
			...
			case ePM_Play:
				{
					SAudioCallBackInfos callbackInfos(this, reinterpret_cast<void*>(static_cast<UINT_PTR>(m_oPlayActivationInfo.pGraph->GetGraphId())), this, eARF_PRIORITY_NORMAL | eARF_SYNC_FINISHED_CALLBACK);
