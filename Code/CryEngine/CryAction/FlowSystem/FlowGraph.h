...
inline string CFlowGraphBase::ToString(const TFlowInputData &value)
{
	...
	{
		case eFDT_EntityId: return ToString(*value.GetPtr<EntityId>());
		case eFDT_String:   return ToString(*value.GetPtr<string>());
		case eFDT_Float:    return ToString(*value.GetPtr<float>());
		case eFDT_Vec3:     return ToString(*value.GetPtr<Vec3>());
		case eFDT_Bool:     return ToString(*value.GetPtr<bool>());
		case eFDT_Int:      return ToString(*value.GetPtr<int>());
