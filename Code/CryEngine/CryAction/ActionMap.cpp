...
void CActionMap::Enable(bool enable)
{
	...
	{
		m_pActionMapManager->BroadcastActionMapEvent(SActionMapEvent(SActionMapEvent::eActionMapManagerEvent_ActionMapStatusChanged, (UINT_PTR)this, (UINT_PTR)m_enabled));
	}
}
