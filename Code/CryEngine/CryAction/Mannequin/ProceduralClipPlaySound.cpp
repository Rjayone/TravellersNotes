...
SERIALIZATION_ENUM(eAOOCT_SingleRay, "SingleRay", "Single Ray");
SERIALIZATION_ENUM(eAOOCT_MultiRay, "MultiRay", "Multi Ray");
...
public:
	...
	void SetAudioObjectPos(QuatT const& rOffset)
	{
		if (m_pIEntityAudioProxy != NULL)
		{
			m_pIEntityAudioProxy->SetAuxAudioProxyOffset(Matrix34(IDENTITY, rOffset.t));
		}
	}
