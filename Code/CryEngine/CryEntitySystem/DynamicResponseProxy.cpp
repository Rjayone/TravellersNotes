...
void CDynamicResponseProxy::ProcessEvent(SEntityEvent& event)
{
	...
	{
		m_pResponseActor->GetLocalVariables()->SetVariableValue("Name", m_pResponseActor->GetName().GetText().c_str());
	}
}
...
//////////////////////////////////////////////////////////////////////////
void CDynamicResponseProxy::QueueSignal(const char* pSignalName, DRS::IVariableCollectionSharedPtr pSignalContext /* = nullptr */, float delayBeforeFiring /* = 0.0f */)
{
	gEnv->pDynamicResponseSystem->QueueSignal(pSignalName, m_pResponseActor, pSignalContext, delayBeforeFiring);
}
