...
struct IAudioSystemImplementation
{
	...
	// Returns:
	//      eARS_SUCCESS if the object has been successfully updated, eARS_FAILURE otherwise.
	//////////////////////////////////////////////////////////////////////////
	...
	//												 AudioSystemImplementation code to manage the AudioObject on which the stand alone audio file is played.
	//			szFile					 - name of or path to the stand alone audio file to be played.
	// Returns:
	//      eARS_SUCCESS if the files started playback, eARS_FAILURE otherwise.
	// See Also:
	//			StopFile
	//////////////////////////////////////////////////////////////////////////
	virtual EAudioRequestStatus PlayFile(IATLAudioObjectData* const pAudioObjectData, char const* const szFile) = 0;
	...
	// Arguments:
	//      pAudioObjectData - implementation-specific data needed by the audio middleware and the AudioSystemImplementation code
	//												 to manage the AudioObject on which the stand alone audio file is stopped.
	//			szFile					 - name of or path to the stand alone audio file to be stopped.
	// Returns:
	//      eARS_SUCCESS if the files stopped, is stopping or is not playing anymore, eARS_FAILURE otherwise.
	// See Also:
	//			PlayFile
	//////////////////////////////////////////////////////////////////////////
	virtual EAudioRequestStatus StopFile(IATLAudioObjectData* const pAudioObjectData, char const* const szFile) = 0;
	...
	virtual EAudioRequestStatus SetPosition(
		IATLAudioObjectData* const pAudioObjectData,
		CAudioObjectTransformation const& oWorldPosition) = 0;
	...
	virtual EAudioRequestStatus SetListenerPosition(
		...
		CAudioObjectTransformation const& oNewPosition) = 0;
