...
#if CRY_PLATFORM_64BIT // copy more data, since the block itself is bigger
			pDst[3] = pSrc[3];		
			pDst[4] = pSrc[4];		
#endif
		}
...
inline void JobManager::SJobSyncVariable::SetRunning() volatile
{
	...
	do
	{
		...
		{
			CryFatalError("JobManager: Atomic counter overflow");
		}
...
{	
	...
	do
	{
		...
		{
			CryFatalError("JobManager: Atomic counter underflow");
		}
