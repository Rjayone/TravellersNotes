...
#include <Serialization/SharedPtr.h>
...
#define STORE_EVENT_NAME
	...
	private:
		...
		BlackboardVariableArray m_blackboardVariableArray;	// N.B. If using regular std::find proves too slow we could optimize by sorting elements.
	};
