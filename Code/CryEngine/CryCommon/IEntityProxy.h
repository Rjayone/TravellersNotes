...
struct IEntityAudioProxy : public IEntityProxy
{
	...
	virtual void											SetAuxAudioProxyOffset(Matrix34 const& rOffset, TAudioProxyID const nAudioProxyLocalID = DEFAULT_AUDIO_PROXY_ID) = 0;
	virtual Matrix34 const&						GetAuxAudioProxyOffset(TAudioProxyID const nAudioProxyLocalID = DEFAULT_AUDIO_PROXY_ID) = 0;
	virtual void											PlayFile(char const* const szFile, TAudioProxyID const nAudioProxyLocalID = DEFAULT_AUDIO_PROXY_ID, SAudioCallBackInfos const& callBackInfos = SAudioCallBackInfos::GetEmptyObject()) = 0;
	virtual void											StopFile(char const* const szFile, TAudioProxyID const nAudioProxyLocalID = DEFAULT_AUDIO_PROXY_ID, SAudioCallBackInfos const& callBackInfos = SAudioCallBackInfos::GetEmptyObject()) = 0;
	virtual bool											ExecuteTrigger(TAudioControlID const nTriggerID, ELipSyncMethod const eLipSyncMethod, TAudioProxyID const nAudioProxyLocalID = DEFAULT_AUDIO_PROXY_ID, SAudioCallBackInfos const& callBackInfos = SAudioCallBackInfos::GetEmptyObject()) = 0;
...
{
	virtual void QueueSignal(const char* pSignalName, DRS::IVariableCollectionSharedPtr pSignalContext /* = nullptr */, float delayBeforeFiring /* = 0.0f */) = 0;
