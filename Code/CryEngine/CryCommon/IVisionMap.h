...
// These flags will prevent ray casting through 'soft cover' colliders. These are colliders that a character can still
// pass through but should block any vision. Examples of these can be: bushes, tall grass, etc.
