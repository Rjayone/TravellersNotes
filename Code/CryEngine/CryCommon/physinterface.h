...
struct pe_action_update_constraint : pe_action {
	...
	pe_action_update_constraint() { type=type_id; MARK_UNUSED idConstraint,pt[0],pt[1],qframe[0],qframe[1],maxPullForce,maxBendTorque,hardnessLin,hardnessAng,damping; 
