...
#   error Linux/Android/Apple do not support evaluation version 
# endif
#endif
...
#if CRY_PLATFORM_WINDOWS && (!defined(_RELEASE) || defined(RESOURCE_COMPILER) || defined(IS_PROSDK))
...
#if !CRY_PLATFORM_DURANGO && !defined(NULL_RENDERER)
