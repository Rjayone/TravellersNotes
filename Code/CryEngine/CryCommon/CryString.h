...
public:
	...
	//! Format string using a va_list initialized with va_start
...
//////////////////////////////////////////////////////////////////////////
#if (CRY_PLATFORM_WINDOWS && CRY_PLATFORM_32BIT) && defined(_STLP_BEGIN_NAMESPACE) && !defined(DONT_BAN_STD_STRING)
