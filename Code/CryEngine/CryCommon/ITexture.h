...
enum ETextureFlags
{
	...
	FT_USAGE_READBACK          = BIT(9), // R: allow read-back of the texture contents by the CPU
	...
	FT_DONT_RESIZE             = BIT(14), // REMOVE
	FT_CUSTOM_FORMAT           = BIT(15), // REMOVE
	...
	FT_USAGE_PREDICATED_TILING = BIT(19), // REMOVE (was 360)
