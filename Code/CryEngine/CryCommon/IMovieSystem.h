...
struct IMovieSystem
{
	...
	virtual void PlaySequence(const char *pSequenceName, IAnimSequence *pParentSeq = NULL, bool bResetFX = true, bool bTrackedSequence = false, float startTime = -FLT_MAX, float endTime = -FLT_MAX) = 0;

	// Start playing sequence.
	// Call ignored if sequence is already playing.
	// @param sequence Pointer to Valid sequence to play.
	virtual void PlaySequence(IAnimSequence *pSequence, IAnimSequence *pParentSeq = NULL, bool bResetFX = true, bool bTrackedSequence = false, float startTime = -FLT_MAX, float endTime = -FLT_MAX) = 0;
	...
	*/
	...
	virtual void StartCapture(IAnimSequence* seq, const ICaptureKey& key) = 0;
