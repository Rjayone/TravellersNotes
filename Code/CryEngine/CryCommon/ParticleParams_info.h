...
ENUM_INFO_BEGIN(EAudioObjectObstructionCalcType)
	ENUM_ELEM_INFO(, eAOOCT_Ignore)
	ENUM_ELEM_INFO(, eAOOCT_SingleRay)
	ENUM_ELEM_INFO(, eAOOCT_MultiRay)
ENUM_INFO_END(EAudioObjectObstructionCalcType)
