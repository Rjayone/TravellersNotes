...
namespace NTypelist
{
	namespace impl { template<class TList> struct length; }
	namespace impl { template<class TList> struct max_alignment; }
	namespace impl { template<class TList> struct max_sizeof; }
	namespace impl { template<class TList, class T> struct find; }
	namespace impl { template<class TList, size_t Index> struct get; }
	namespace impl { template<class TList1, class TList2> struct join; }
	namespace impl { template<class TList, template<class> class TTrait> struct runtime_trait_evaluator; }
	namespace impl { template<class TList, class TInit, template<class, class> class TFunc> struct foldl; }
	namespace impl { template<class TList, class TInit, template<class, class> class TFunc> struct foldr; }
	 ...
	 * Returns 0 for an empty Typelist.
	 */
	template<class TList>
	struct MaximumSize
	{
	 ...
	 * Returns 1 for an empty Typelist.
	 */
	template<class TList>
