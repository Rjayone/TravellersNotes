...
// Copyright (C), Crytek, 2001-2015.
// CRY_ASSERT and assert helpers.
...
#if defined(_DEBUG) && !defined(FORCE_STANDARD_ASSERT)
...
// Remember the value of NDEBUG
#if defined(NDEBUG)
#	define CRY_WAS_NDEBUG_SET 1
#else
#	define CRY_WAS_NDEBUG_SET 0
#endif
